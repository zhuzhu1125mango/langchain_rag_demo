...
REM LangChain RAG Demo - View Production Logs (Windows)
...
if %ERRORLEVEL% equ 0 (
    ...
    pwsh -NoProfile -ExecutionPolicy Bypass -File "%~dp0logs-prod.ps1" %*
    exit /b %ERRORLEVEL%
)
...
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0logs-prod.ps1" %*
exit /b %ERRORLEVEL%
